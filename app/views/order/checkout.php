    ...
    <div class="checkout-container">
        ...
        <div class="checkout-form">
            ...
            <form id="checkoutForm" method="POST" action="/shop_giay/order/checkout">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="recipient_name" class="form-control"
                            value="<?= htmlspecialchars($user['full_name'] ?? $_POST['recipient_name'] ?? '') ?>"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="shipping_address" class="form-control"
                            required><?= htmlspecialchars($user['address'] ?? $_POST['shipping_address'] ?? '') ?></textarea>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="payment-methods">
                        <!-- Thanh toán COD -->
                        <div class="payment-method <?= ($_POST['payment_method'] ?? 'COD') == 'COD' ? 'selected' : '' ?>"
                        ...
                        <div class="payment-method <?= ($_POST['payment_method'] ?? '') == 'QR' ? 'selected' : '' ?>"
            ...
            <div id="qrSection" class="qr-section">
                ...
                <div class="qr-code">
                    <img src="/shop_giay/public/images/qr-payment.png" alt="QR Code"
                        onerror="this.src='https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=DO<?= time() ?>-<?= $total ?>'">
                </div>
        ...
        <div class="order-summary">
            ...
            <div class="summary-row total">
                <span>Tổng cộng:</span>
                <span
                    id="finalTotal"><?= number_format(($total ?? 0) >= 500000 ? ($total ?? 0) : ($total ?? 0) + 30000, 0, ',', '.') ?>đ</span>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    // Hàm gửi đơn hàng chung cho cả COD và QR
    ...
    document.getElementById('checkoutForm').addEventListener('submit', function (e) {
        ...
        if (paymentMethod === 'QR') {
            selectPayment('QR'); // Hiển thị khung QR
            return;
        }
    ...
    function selectPayment(method) {
        ...
        if (window.event && window.event.currentTarget && window.event.currentTarget.classList) {
            ...
            // Tìm phần tử tương ứng nếu không có event
            const target = document.querySelector(`.payment-method input[value="${method}"]`)?.closest('.payment-method');
